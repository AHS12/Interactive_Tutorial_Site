...
//    register_as_teacher();
    ...
    $lastname = $db->escape_string($_POST['lastname']);
    $email = $db->escape_string($_POST['email']);
    $institute = $db->escape_string($_POST['institution']);
    $password = $db->escape_string($_POST['password']);
    $confirmPass = $db->escape_string($_POST['confirm_pass']);
    ...
    if ($password == $confirmPass) {
        ...
        if ($fileSize != false) {
            ...
            if (($fileType != "image/jpeg" && $fileType != "image/png") && $fileType != "image/gif") {
                ...
                $_SESSION['wrong_image_formate'] = 1;
                header("location: ../../public/reg_teacher.php");
                ...
                $query = "INSERT INTO users(firstname,lastname,email,password,institution,user_role,picture) VALUES ";
                $query .= "('$firstname','$lastname','$email','$password','$institute','$userRole','$fileUserImgName')";
