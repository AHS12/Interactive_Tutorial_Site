                ...
                case 'tkhd': // TracK HeaDer atom
                    ...
                    if (!isset($info['video']['rotate'])) {
                        switch ($atom_structure['matrix_a'] . ':' . $atom_structure['matrix_b'] . ':' . $atom_structure['matrix_c'] . ':' . $atom_structure['matrix_d']) {
                            case '1:0:0:1':
                                $info['quicktime']['video']['rotate'] = $info['video']['rotate'] = 0;
                                break;
                            case '0:1:65535:0':
                                $info['quicktime']['video']['rotate'] = $info['video']['rotate'] = 90;
                                break;
                            case '65535:0:0:65535':
                                $info['quicktime']['video']['rotate'] = $info['video']['rotate'] = 180;
                                break;
                            case '0:65535:1:0':
                                $info['quicktime']['video']['rotate'] = $info['video']['rotate'] = 270;
                                break;
                            default:
                                break;
                        }
