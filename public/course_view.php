...
<div id="course_view" class="course_view">
    <div class="container" style="background-color: #182333;height: 300px; width: 100%;">
         <div class="row">
                             ...
                             <div class="col-lg-4">
                                     <img  style="margin-top: 40px;width: 90%;height: 200px;" src="../style/pictures/dash_video_illustration.png">
                                 </div>
                                <div class="col-lg-8">-->
                                    <h2 style="color: #fff;">Real Time Chat System Using PHP Mysql PDO and AJAX</h2>
                               </div>
    </div>
</div>
</div>
