...
<?php require_once("../includes/layouts/header.php") ?>
    ...
    <section>
        ...
        <div class="centered">
            <h1>Learn Coding</h1>
            <hr>
            <a href="<?php if (isset($_SESSION['userfname'])) {
                echo "course_list.php";
            } else echo "#join_pannel" ?>" type="button" class="btn btn-success btn-lg">Start Now</a>
        </div>
    </section>
    <br><br>
    <!-- **********navbar end *********** -->
                ...
                <form>
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-default submit btn-responsive"><i
