                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form action="create_course.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <form action="create_course.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="content_title"> Course Title <span
                                                        class="require">*</span></label>
                                            <input type="text" class="form-control" name="content_title"
                                                   value="<?php echo htmlentities($content_title) ?>"/>
                                            <br>

                                            <label for="content_category"> Course Category <span
                                                        class="require">*</span></label>
                                            ...
                                            <label for="content_level">Course Level <span
                                                        class="require">*</span></label>
                                            ...
                                            <textarea rows="5" class="form-control"
                                                      name="content_requirements"><?php echo $content_requirements ?></textarea>
                                            <br>

                                            <label for="content_what_to_learn">What Will I learn?</label>
                                            <textarea rows="5" class="form-control"
                                                      name="content_what_to_learn"><?php echo $content_what_to_learn ?></textarea>
                                            <br>

                                            <label for="content_details">Course Description</label>
                                            <textarea rows="5" class="form-control"
                                                      name="content_details"><?php echo $content_details ?></textarea>
                                            <br>

                                            <label for="content_tags"> Course Tags <span
                                                        class="require">*</span></label>
                                            <input type="text" class="form-control" name="content_tags"
                                                   value="<?php echo htmlentities($content_tags) ?>"/>
                                            <br>
                        ...
                        <div class="col-md-2" style="margin-left: 5px;">
                            ...
                            <h3>Helpful Tips</h3>
                            <p style="font-size:16px;">Whether you've been teaching for years or are teaching for the
                                first time, you can make an engaging course. We've compiled resources and best practices
