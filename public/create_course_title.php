        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default" style="width: 600px;height: 250px;">
                ...
                <div class="panel-body">
                    <form action="create_course_title.php" method="post">
                        <div class="form-group">
                            ...
                            <br>
                            <input style="float: right; margin-bottom: 10px" type="submit" name="submit" value="Save & Go" class="btn btn-success btn-lg">
                            <br>
                        </div>
                    </form>
