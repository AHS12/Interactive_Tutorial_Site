        ...
        <div class="hero">
            ...
            <div class="button">
                <?php if (logged_in()) { ?>
                    ...
                    <a href="course_list.php" class="btn btn-two wow bounceInUp" data-wow-delay=".9">Explore More</a>
                <?php } else { ?>
                    <a href="#joinPanel" class="btn btn-one wow bounceInUp" data-wow-delay=".8">Join Now</a>
                    <a href="course_list.php" class="btn btn-two wow bounceInUp" data-wow-delay=".9">Explore More</a>
                <?php } ?>
            </div>
        </div>
...
<div id="services" class="services">
    <div class="container">
        ...
        <p class="wow fadeInUp" data-wow-delay="0.4s">Lorem Ipsum is a simply dummy text of the printing and typesetting
            dummy text.</p>
        <div class="row">
                        ...
                        <div class="card-block">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="list-inline">
                                    <li class="margin-t-10"><a
                                                href="course_details.php?content=<?php echo urlencode($content_id) ?>">
    ...
    <div id="team" class="team">
        <div class="container">
            <div class="row">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.4s">Lorem Ipsum passages,and more recently with desktop
                    publishing
                    software</p>
    ...
    <div id="client" class="clients">
        <div class="container">
            <div class="row">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.4s">Lorem Ipsum passages and more recently with publishing
                    software.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-phone"
                                                                          aria-hidden="true"></i></span>
                        <input type="text" class="form-control" aria-describedby="sizing-addon1"
                ...
                <div class="row">
                    ...
                    <div style="display:none;" id="slide-content">
                        <div id="slide-content-0">
                            ...
                            <p>This is mini slider / carousel.</p>
                        ...
                        <div id="slide-content-1">
                            ...
                            <small>October 15 2017 - <a href="#">Read more</a></small>
                        ...
                        <div id="slide-content-2">
                            ...
                            <small>October 19 2017 - <a href="#">Read more</a></small>
                        ...
                        <div id="slide-content-3">
                            ...
                            <small>October 22 2017 - <a href="#">Read more</a></small>
                        ...
                        <div id="slide-content-4">
                            ...
                            <p>Lorem Ipsum Dolor</p>
                            <small>October 25 2017 - <a href="#">Read more</a></small>
