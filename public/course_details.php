    ...
    <div class="jumbotron" id="bgColor">
        <div class="container" id="fntColor">
            ...
            <div id="description">
                ...
                <i class="fa fa-address-card" aria-hidden="true"> Beginner</i>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-body">
                <h1 id="pad"> What will i learn?</h1>
                <div class="col-lg-12">
...
<section>
    ...
    <div>
        ...
        <ol>
            ...
            <li>Have mastered the cutting-edge layout technologies Flexbox and CSS Grid;</li>
